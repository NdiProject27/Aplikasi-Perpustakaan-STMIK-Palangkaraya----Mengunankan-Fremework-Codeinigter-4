...
<div class="col-md-10">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title"><a href="<?= base_url('buku'); ?>" class="btn btn-primary"> <i class=" fas fa-arrow-left"></i></a> Edit Data Mahasiswa</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="jurusan" class="form-control" id="jurusan">
                            <option value=" pilih" <?= ($mahasiswa->jurusan == "pilih" ? "selected" : ""); ?>>Pilih Jurusan</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="jenis_kelamin" class="form-control" id="jenis_kelamin" value="<?= $mahasiswa->jenis_kelamin; ?>">
                            <option value="pilih" <?= ($mahasiswa->jenis_kelamin == "pilih" ? "selected" : ""); ?>>Pilih</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="custom-file col-sm-6">
                        ...
                        <label class="custom-file-label" for="photo"> <?= $mahasiswa->photo; ?></label>
                    </div>
                </div>
            </div>
