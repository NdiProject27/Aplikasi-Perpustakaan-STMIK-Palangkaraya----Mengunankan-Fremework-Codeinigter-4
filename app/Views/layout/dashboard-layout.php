  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?= route_to('user.anggota') ?>" class="nav-link">Anggota</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?= route_to('user.buku') ?>" class="nav-link">Buku</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?= route_to('user.peminjaman') ?>" class="nav-link">Peminjaman</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="<?= route_to('user.Pengembalian') ?>" class="nav-link">Pengembalian</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="dist/img/<?= userLogin()->foto ?>" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
            <a href="<?= route_to('user.profile') ?>" class="d-block"><?= userLogin()->name ?></a>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?= route_to('pengembalian') ?>" class="nav-link">
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; 2021 <a href="">Kelompok Pemograman Framework</a>. </strong> All Rights Reserved.
    </footer>
  </div>
  <!-- ./wrapper -->
