...
<div class="col-md-10">
    ...
    <div class="card card-primary">
        ...
        <form class="" method="POST" action="<?= base_url('peminjaman') ?>" enctype="multipart/form-data">
            <?= csrf_field(); ?>
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="date" class="form-control" name="tgl_pinjam" placeholder="tgl_pinjam ">
                    </div>
                </div>
