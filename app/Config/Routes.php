...
$routes->group('user', ['filter' => 'auth'], function ($routes) {
    ...
    // $routes->get('buku', 'UserController::buku', ['as' => 'user.buku']);
    $routes->get('anggota', 'Mahasiswa::index', ['as' => 'user.anggota']);
    $routes->get('buku', 'Buku::index', ['as' => 'user.buku']);
});
...
// $routes->resource('peminjaman', ['filter' => 'isLoggedIn']);
