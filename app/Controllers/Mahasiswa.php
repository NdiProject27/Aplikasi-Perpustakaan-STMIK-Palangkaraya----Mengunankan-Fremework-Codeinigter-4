...
class Mahasiswa extends BaseController
{
    ...
    public function update($nim)
    {
        ...
        $filePhotoLama = $this->request->getFile('photo');
        //pengecekan photo lama
        if ($filePhotoLama->getError() == 4) {
            $namaPhoto = 'otomatis.jpg';
        } else {
            $namaPhoto = $filePhotoLama->getRandomName();
            $filePhotoLama->move('photo', $namaPhoto);
            unlink('photo/' . $this->request->getVar('PhotoLama'));
        }
